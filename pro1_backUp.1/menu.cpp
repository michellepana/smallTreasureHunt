...
int* initSetUp(){
    ...
    cout << "Please enter the number of steps you wish the ant to take after it's put on the board (no limits for now) " << endl;
    steps = getStepInput();
    ...
    while(true){
        ...
        if(cin.fail()){
            ...
            if(userStepInput >= 0){
                ...
                cout << "Oops, that input was smaller than 0. Please enter a number >= 0." << endl;
            }
        }
    }
}